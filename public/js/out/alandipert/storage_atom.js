...
var G__6083_6084 = cljs.core.deref(f);
goog.Timer.clear(G__6083_6084);
} else {
}
...
var G__6089 = atom;
cljs.core.add_watch(G__6089,cljs.core.cst$kw$alandipert$storage_DASH_atom_SLASH_storage_DASH_watch,((function (G__6089,existing,debounce){
return (function (p1__6087_SHARP_,p2__6088_SHARP_,p3__6085_SHARP_,p4__6086_SHARP_){
if(((alandipert.storage_atom._STAR_watch_active_STAR_) && (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p3__6085_SHARP_,p4__6086_SHARP_)))){
var G__6090 = ((function (G__6089,existing,debounce){
return (function (){
return alandipert.storage_atom._commit_BANG_(backend,p4__6086_SHARP_);
});})(G__6089,existing,debounce))
;
var G__6091 = (function (){var or__3949__auto__ = alandipert.storage_atom._STAR_storage_delay_STAR_;
...
return (debounce.cljs$core$IFn$_invoke$arity$2 ? debounce.cljs$core$IFn$_invoke$arity$2(G__6090,G__6091) : debounce.call(null,G__6090,G__6091));
} else {
return null;
}
});})(G__6089,existing,debounce))
...
var _STAR_watch_active_STAR_6092 = alandipert.storage_atom._STAR_watch_active_STAR_;
alandipert.storage_atom._STAR_watch_active_STAR_ = false;

try{return cljs.core.reset_BANG_(atom,default$);
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_6092;
}} else {
...
var _STAR_watch_active_STAR_6093 = alandipert.storage_atom._STAR_watch_active_STAR_;
alandipert.storage_atom._STAR_watch_active_STAR_ = false;
...
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_6093;
}} else {
return null;
}
} else {
...
return alandipert.storage_atom.maybe_update_backend(atom,storage,k,default$,p1__6094_SHARP_);
});})(default$))
);
});
/**
