...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__2706){
var map__2707 = p__2706;
var map__2707__$1 = ((((!((map__2707 == null)))?(((((map__2707.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2707.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__2707):map__2707);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2707__$1,cljs.core.cst$kw$handler);
...
return (function (p1__2709_SHARP_){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__3949__auto__ = p1__2709_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__2710){
var map__2711 = p__2710;
var map__2711__$1 = ((((!((map__2711 == null)))?(((((map__2711.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2711.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__2711):map__2711);
var request = map__2711__$1;
var interceptors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2711__$1,cljs.core.cst$kw$interceptors);
