...
var G__2718 = format;
var G__2718__$1 = (((G__2718 instanceof cljs.core.Keyword))?G__2718.fqn:null);
switch (G__2718__$1) {
case "transit":
return ajax.transit.transit_request_format.cljs$core$IFn$_invoke$arity$1(format_params);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__2720 = cljs.core.second(format);
var G__2721 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__2720,G__2721) : ajax.easy.keyword_response_format_element.call(null,G__2720,G__2721));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__2724_SHARP_){
return ajax.easy.keyword_response_format_element(p1__2724_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__2725){
var map__2726 = p__2725;
var map__2726__$1 = ((((!((map__2726 == null)))?(((((map__2726.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2726.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__2726):map__2726);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2726__$1,cljs.core.cst$kw$handler);
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2726__$1,cljs.core.cst$kw$error_DASH_handler);
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2726__$1,cljs.core.cst$kw$finally);
...
return ((function (h,e,map__2726,map__2726__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__2728){
var vec__2729 = p__2728;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2729,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2729,(1),null);
var fexpr__2732_2733 = (cljs.core.truth_(ok)?h:e);
(fexpr__2732_2733.cljs$core$IFn$_invoke$arity$1 ? fexpr__2732_2733.cljs$core$IFn$_invoke$arity$1(result) : fexpr__2732_2733.call(null,result));
...
;})(h,e,map__2726,map__2726__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__2734){
var map__2735 = p__2734;
...
var opts = map__2735__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2735__$1,cljs.core.cst$kw$method);
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2735__$1,cljs.core.cst$kw$format);
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2735__$1,cljs.core.cst$kw$response_DASH_format);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2735__$1,cljs.core.cst$kw$params);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2735__$1,cljs.core.cst$kw$body);
