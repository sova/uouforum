...
var m__4244__auto__ = (tailrecursion.cljson._encode[goog.typeOf(x__4243__auto__)]);
...
var m__4244__auto____$1 = (tailrecursion.cljson._encode["_"]);
...
var G__6052 = JSON.parse(s);
return (tailrecursion.cljson.decode.cljs$core$IFn$_invoke$arity$1 ? tailrecursion.cljson.decode.cljs$core$IFn$_invoke$arity$1(G__6052) : tailrecursion.cljson.decode.call(null,G__6052));
});
...
var temp__5455__auto__ = (function (){var and__3938__auto__ = cljs.core._STAR_print_meta_STAR_;
...
return ["z",(tailrecursion.cljson.encode.cljs$core$IFn$_invoke$arity$1 ? tailrecursion.cljson.encode.cljs$core$IFn$_invoke$arity$1(m) : tailrecursion.cljson.encode.call(null,m)),(function (){var G__6055 = cljs.core.with_meta(x,null);
return (tailrecursion.cljson.encode.cljs$core$IFn$_invoke$arity$1 ? tailrecursion.cljson.encode.cljs$core$IFn$_invoke$arity$1(G__6055) : tailrecursion.cljson.encode.call(null,G__6055));
})()];
} else {
...
var or__3949__auto__ = tailrecursion.cljson.interpret(x);
...
var G__6070 = (i + (1));
var G__6071 = len;
var G__6072 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(out,(function (){var G__6060 = (o[i]);
return (tailrecursion.cljson.decode.cljs$core$IFn$_invoke$arity$1 ? tailrecursion.cljson.decode.cljs$core$IFn$_invoke$arity$1(G__6060) : tailrecursion.cljson.decode.call(null,G__6060));
})());
i = G__6070;
len = G__6071;
out = G__6072;
...
var G__6073 = (i + (2));
var G__6074 = len;
var G__6075 = cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(out,(function (){var G__6061 = (o[i]);
return (tailrecursion.cljson.decode.cljs$core$IFn$_invoke$arity$1 ? tailrecursion.cljson.decode.cljs$core$IFn$_invoke$arity$1(G__6061) : tailrecursion.cljson.decode.call(null,G__6061));
})(),(function (){var G__6062 = (o[(i + (1))]);
return (tailrecursion.cljson.decode.cljs$core$IFn$_invoke$arity$1 ? tailrecursion.cljson.decode.cljs$core$IFn$_invoke$arity$1(G__6062) : tailrecursion.cljson.decode.call(null,G__6062));
})());
i = G__6073;
len = G__6074;
out = G__6075;
...
if((i > (0))){
var G__6076 = (i - (1));
var G__6077 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,(function (){var G__6063 = (o[i]);
return (tailrecursion.cljson.decode.cljs$core$IFn$_invoke$arity$1 ? tailrecursion.cljson.decode.cljs$core$IFn$_invoke$arity$1(G__6063) : tailrecursion.cljson.decode.call(null,G__6063));
})());
i = G__6076;
out = G__6077;
continue;
...
var G__6078 = (i + (1));
var G__6079 = len;
var G__6080 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(out,(function (){var G__6064 = (o[i]);
return (tailrecursion.cljson.decode.cljs$core$IFn$_invoke$arity$1 ? tailrecursion.cljson.decode.cljs$core$IFn$_invoke$arity$1(G__6064) : tailrecursion.cljson.decode.call(null,G__6064));
})());
i = G__6078;
len = G__6079;
out = G__6080;
...
break;
case "z":
var m = (function (){var G__6065 = (o[(1)]);
return (tailrecursion.cljson.decode.cljs$core$IFn$_invoke$arity$1 ? tailrecursion.cljson.decode.cljs$core$IFn$_invoke$arity$1(G__6065) : tailrecursion.cljson.decode.call(null,G__6065));
})();
var v = (function (){var G__6066 = (o[(2)]);
return (tailrecursion.cljson.decode.cljs$core$IFn$_invoke$arity$1 ? tailrecursion.cljson.decode.cljs$core$IFn$_invoke$arity$1(G__6066) : tailrecursion.cljson.decode.call(null,G__6066));
})();
return cljs.core.with_meta(v,m);

break;
default:
var temp__5455__auto__ = (function (){var or__3949__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(cljs.reader._STAR_tag_table_STAR_),tag);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
var G__6067 = (function (){var G__6068 = (o[(1)]);
return (tailrecursion.cljson.decode.cljs$core$IFn$_invoke$arity$1 ? tailrecursion.cljson.decode.cljs$core$IFn$_invoke$arity$1(G__6068) : tailrecursion.cljson.decode.call(null,G__6068));
})();
return (reader.cljs$core$IFn$_invoke$arity$1 ? reader.cljs$core$IFn$_invoke$arity$1(G__6067) : reader.call(null,G__6067));
} else {
