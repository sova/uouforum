...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.call(null,(function (p__23248){
var vec__23249 = p__23248;
var _ = cljs.core.nth.call(null,vec__23249,(0),null);
var v = cljs.core.nth.call(null,vec__23249,(1),null);
...
if(((((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$)))) && (cljs.core.every_QMARK_.call(null,(function (p1__23252_SHARP_){
return (((p1__23252_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__23252_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.call(null,G__23253,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__23253;
}
});
...
var len__4531__auto___23256 = arguments.length;
var i__4532__auto___23257 = (0);
while(true){
if((i__4532__auto___23257 < len__4531__auto___23256)){
args__4534__auto__.push((arguments[i__4532__auto___23257]));

var G__23258 = (i__4532__auto___23257 + (1));
i__4532__auto___23257 = G__23258;
continue;
} else {
}
break;
...
var G__23255 = cljs.core.reduce.call(null,cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes))){
return cljs.core.assoc.call(null,G__23255,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec.call(null,classes));
} else {
return G__23255;
}
} else {
...
/** @this {Function} */
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq23254){
var self__4519__auto__ = this;
return self__4519__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq23254));
});
...
var vec__23261 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__23261,(0),null);
var names = cljs.core.nth.call(null,vec__23261,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css.call(null,cljs.core.some.call(null,((function (matches,vec__23261,tag_name,names){
return (function (p1__23259_SHARP_){
if(cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__23259_SHARP_))){
return p1__23259_SHARP_;
} else {
return null;
}
});})(matches,vec__23261,tag_name,names))
,names)),cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.comp.call(null,cljs.core.filter.call(null,((function (matches,vec__23261,tag_name,names){
return (function (p1__23260_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__23260_SHARP_));
});})(matches,vec__23261,tag_name,names))
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__23264){
var vec__23265 = p__23264;
var seq__23266 = cljs.core.seq.call(null,vec__23265);
var first__23267 = cljs.core.first.call(null,seq__23266);
var seq__23266__$1 = cljs.core.next.call(null,seq__23266);
var tag = first__23267;
var content = seq__23266__$1;
...
var vec__23268 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__23268,(0),null);
var id = cljs.core.nth.call(null,vec__23268,(1),null);
var class$ = cljs.core.nth.call(null,vec__23268,(2),null);
