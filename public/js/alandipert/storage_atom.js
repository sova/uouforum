...
return m__4244__auto__.call(null,this$,not_found);
} else {
var m__4244__auto____$1 = (alandipert.storage_atom._get["_"]);
if(!((m__4244__auto____$1 == null))){
return m__4244__auto____$1.call(null,this$,not_found);
} else {
...
if(!((m__4244__auto__ == null))){
return m__4244__auto__.call(null,this$,value);
} else {
var m__4244__auto____$1 = (alandipert.storage_atom._commit_BANG_["_"]);
if(!((m__4244__auto____$1 == null))){
return m__4244__auto____$1.call(null,this$,value);
} else {
...
return cljs.core._write.call(null,writer__4193__auto__,"alandipert.storage-atom/StorageBackend");
});
...
var G__25704 = atom;
cljs.core.add_watch.call(null,G__25704,new cljs.core.Keyword("alandipert.storage-atom","storage-watch","alandipert.storage-atom/storage-watch",1159565749),((function (G__25704,existing,debounce){
return (function (p1__25702_SHARP_,p2__25703_SHARP_,p3__25700_SHARP_,p4__25701_SHARP_){
if(((alandipert.storage_atom._STAR_watch_active_STAR_) && (cljs.core.not_EQ_.call(null,p3__25700_SHARP_,p4__25701_SHARP_)))){
return debounce.call(null,((function (G__25704,existing,debounce){
return (function (){
return alandipert.storage_atom._commit_BANG_.call(null,backend,p4__25701_SHARP_);
});})(G__25704,existing,debounce))
,(function (){var or__3949__auto__ = alandipert.storage_atom._STAR_storage_delay_STAR_;
...
var _STAR_watch_active_STAR_25705 = alandipert.storage_atom._STAR_watch_active_STAR_;
alandipert.storage_atom._STAR_watch_active_STAR_ = false;

try{return cljs.core.reset_BANG_.call(null,atom,default$);
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_25705;
}} else {
...
var _STAR_watch_active_STAR_25706 = alandipert.storage_atom._STAR_watch_active_STAR_;
alandipert.storage_atom._STAR_watch_active_STAR_ = false;
...
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_25706;
}} else {
return null;
}
} else {
...
return alandipert.storage_atom.maybe_update_backend.call(null,atom,storage,k,default$,p1__25707_SHARP_);
});})(default$))
);
});
/**
